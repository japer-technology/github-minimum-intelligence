...
Before contributing, please read the [FINAL WARNING](FINAL-WARNING.md) and the [Four Laws of AI](THE-FOUR-LAWS-OF-AI.md).
...
- Any security implications — review the [Blast Radius Analysis](WARNING-BLAST-RADIUS.md) to understand the threat model.
...
If you discover a security vulnerability, **do not open a public issue**. Instead, refer to the [Incident Response](INCIDENT-RESPONSE.md) plan and contact the maintainers privately.

All contributions are subject to the project's [Security Assessment](SECURITY-ASSESSMENT.md) and [Blast Radius Analysis](WARNING-BLAST-RADIUS.md). Changes that expand the agent's capabilities or permissions require careful review.
