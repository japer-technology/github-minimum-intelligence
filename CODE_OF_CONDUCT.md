...
- Any conduct that would violate the [Four Laws of AI](THE-FOUR-LAWS-OF-AI.md).

---

## Alignment with the Four Laws

This project defines [Four Laws of AI](THE-FOUR-LAWS-OF-AI.md) that govern the system's behavior. Contributors — human and automated alike — are expected to uphold these principles:
...
This Code of Conduct is adapted from the [Contributor Covenant](https://www.contributor-covenant.org/), version 2.1, with additions specific to this project's [Four Laws of AI](THE-FOUR-LAWS-OF-AI.md) and [FINAL WARNING](FINAL-WARNING.md).
